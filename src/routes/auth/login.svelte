		...
		<div class="w-full lg:w-5/12 px-2">
			...
			>
				<div class="rounded-t mb-0 px-4 py-6">
					<div class="text-center mb-3">
						<h6 class="text-gray-200 text-sm font-bold">Sign In</h6>
					</div>
					...
					<form>
						...
						<div class="relative w-full mb-3">
							...
							<input
								id="grid-password"
								type="password"
								class="border-0 px-3 py-3 placeholder-gray-700 text-white  bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
			...
			<div class="flex flex-wrap mt-6 relative">
				...
				<div class="w-1/2 text-right">
					<a href="/auth/register" class="text-gray-600">
