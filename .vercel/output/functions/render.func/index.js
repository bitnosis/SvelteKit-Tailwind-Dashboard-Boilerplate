...
// .svelte-kit/output/server/_app/immutable/chunks/index-30e4655b.js
function noop() {
}
...
// .svelte-kit/output/server/_app/immutable/chunks/hooks-65a46288.js
var hooks_65a46288_exports = {};
__export(hooks_65a46288_exports, {
...
var getSession;
var init_hooks_65a46288 = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/hooks-65a46288.js"() {
    getSession = async (event) => {
      let cookies = event.request.headers.get("cookie");
      const user2 = parseCookie(cookies).user ? parseCookie(cookies).user : null;
  ...
  return Object.create(
    {
      ...
      withAttributes: function(attributes) {
        return init2(this.converter, assign2({}, this.attributes, attributes));
      },
      withConverter: function(converter2) {
        return init2(assign2({}, this.converter, converter2), this.attributes);
      }
    },
    {
...
// .svelte-kit/output/server/_app/immutable/chunks/userStore-f6242bd9.js
...
var subscriber_queue2, user, loginUser, setCookie2, removeCookie;
var init_userStore_f6242bd9 = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/userStore-f6242bd9.js"() {
    init_index_30e4655b();
    init_js_cookie();
    subscriber_queue2 = [];
    user = writable2({ user: null, theme: null });
    loginUser = (newUser) => {
      user.set({ user: newUser.id, theme: "light" });
      newUser.user === null ? removeCookie() : setCookie2("user", newUser.id);
      if (!js_cookie_default.get("theme")) {
        setCookie2("theme", "light");
      }
    };
    setCookie2 = async (key2, value) => {
      await js_cookie_default.set(key2, value, { expires: 7 });
    };
    removeCookie = async (key2) => {
    };
  }
});

// .svelte-kit/output/server/_app/immutable/chunks/DarkModeToggle-5c6d9d2a.js
var DarkModeToggle;
var init_DarkModeToggle_5c6d9d2a = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/DarkModeToggle-5c6d9d2a.js"() {
    init_index_30e4655b();
    init_userStore_f6242bd9();
    DarkModeToggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_user();
      return `<label for="${"default-toggle"}" class="${"inline-flex relative items-center cursor-pointer"}"><input type="${"checkbox"}" ${isDark ? "checked" : ""} value="${""}" id="${"default-toggle"}" class="${"sr-only peer"}">
	<div class="${"w-10 h-5 bg-gray-400 peer-focus:outline-none peer-focus:ring-1 peer-focus:ring-white-300 dark:peer-focus:ring-white-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[-1px] after:left-[-2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-yellow-600"}"></div>
	<span class="${"ml-3 text-sm font-medium text-gray-500 dark:text-gray-300"}">${$user.theme == "dark" ? `<i class="${"fas fa-moon"}"></i>` : `<i class="${"fas fa-sun"}"></i>`}</span></label>`;
    });
  }
});
...
var require_helpers2 = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/helpers.js"(exports) {
    ...
    var setItemAsync = (storage, key2, data) => __awaiter(void 0, void 0, void 0, function* () {
      (0, exports.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.setItem(key2, JSON.stringify(data)));
    });
    exports.setItemAsync = setItemAsync;
    var getItemAsync = (storage, key2) => __awaiter(void 0, void 0, void 0, function* () {
      const value = (0, exports.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.getItem(key2));
      if (!value)
        return null;
      try {
    ...
    var getItemSynchronously = (storage, key2) => {
      const value = (0, exports.isBrowser)() && (storage === null || storage === void 0 ? void 0 : storage.getItem(key2));
    ...
    var removeItemAsync = (storage, key2) => __awaiter(void 0, void 0, void 0, function* () {
      (0, exports.isBrowser)() && (yield storage === null || storage === void 0 ? void 0 : storage.removeItem(key2));
    });
...
var require_node_gyp_build = __commonJS({
  "node_modules/node-gyp-build/index.js"(exports, module) {
    ...
    module.exports = load9;
    function load9(dir) {
      return runtimeRequire(load9.path(dir));
    }
    load9.path = function(dir) {
    ...
    function parseTags(file11) {
      var arr = file11.split(".");
      var extension = arr.pop();
      var tags = { file: file11, specificity: 0 };
      if (extension !== "node")
        return;
    ...
    load9.parseTags = parseTags;
    load9.matchTags = matchTags;
    load9.compareTags = compareTags;
    load9.parseTuple = parseTuple;
    load9.matchTuple = matchTuple;
    load9.compareTuples = compareTuples;
  }
});
  ...
  "node_modules/websocket/lib/WebSocketConnection.js"(exports, module) {
    ...
    function instrumentSocketForDebugging(connection, socket) {
      ...
      for (var key2 in socket) {
        if ("function" !== typeof socket[key2]) {
          continue;
        }
...
var require_WebSocketRequest = __commonJS({
  "node_modules/websocket/lib/WebSocketRequest.js"(exports, module) {
    ...
    WebSocketRequest.prototype.parseExtensions = function(extensionsString) {
      ...
      extensions.forEach(function(extension, index11, array2) {
        var params = extension.split(headerParamSplitRegExp);
        var extensionName = params[0];
        var extensionParams = params.slice(1);
        extensionParams.forEach(function(rawParam, index12, array3) {
          var arr = rawParam.split("=");
          var obj2 = {
            name: arr[0],
            value: arr[1]
          };
          array3.splice(index12, 1, obj2);
        });
        var obj = {
          name: extensionName,
          params: extensionParams
        };
        array2.splice(index11, 1, obj);
      });
      return extensions;
    };
...
var require_WebSocketServer = __commonJS({
  "node_modules/websocket/lib/WebSocketServer.js"(exports, module) {
    ...
    WebSocketServer.prototype.handleConnectionClose = function(connection, closeReason, description) {
      var index11 = this.connections.indexOf(connection);
      if (index11 !== -1) {
        this.connections.splice(index11, 1);
      }
      this.emit("close", connection, closeReason, description);
    };
    WebSocketServer.prototype.handleRequestResolved = function(request) {
      var index11 = this.pendingRequests.indexOf(request);
      if (index11 !== -1) {
        this.pendingRequests.splice(index11, 1);
      }
    };
...
var require_WebSocketRouter = __commonJS({
  "node_modules/websocket/lib/WebSocketRouter.js"(exports, module) {
    ...
    WebSocketRouter.prototype.unmount = function(path, protocol) {
      var index11 = this.findHandlerIndex(this.pathToRegExp(path).toString(), protocol);
      if (index11 !== -1) {
        this.handlers.splice(index11, 1);
      } else {
...
// .svelte-kit/output/server/_app/immutable/chunks/supabaseClient-e400011c.js
var import_supabase_js, supabaseUrl, supabaseAnonKey, supabase;
var init_supabaseClient_e400011c = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/supabaseClient-e400011c.js"() {
    import_supabase_js = __toESM(require_main6(), 1);
    supabaseUrl = "https://mmruzzkvspnarqrhyrww.supabase.co";
    supabaseAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1tcnV6emt2c3BuYXJxcmh5cnd3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjAwMzA4NDIsImV4cCI6MTk3NTYwNjg0Mn0.LOkHPPLIaULENsLalCKXhqeISCflR1SO5tmRBDgM72o";
...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    init_index_30e4655b();
    init_DarkModeToggle_5c6d9d2a();
    init_supabaseClient_e400011c();
    init_js_cookie();
    init_userStore_f6242bd9();
...
<div><main><div class="${"float-right pr-16 py-5"}">${validate_component(DarkModeToggle, "DarkModeToggle").$$render($$result, {}, {}, {})}</div>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    file = "_app/immutable/pages/__layout.svelte-27995575.js";
    imports = ["_app/immutable/pages/__layout.svelte-27995575.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/DarkModeToggle-194779be.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/supabaseClient-62fcc2af.js", "_app/immutable/chunks/preload-helper-c28b9807.js"];
    stylesheets = ["_app/immutable/assets/DarkModeToggle-b0041227.css"];
  }
});
...
<div class="${"flex h-screen bg-gray-100 justify-items-center"}">
	<div class="${"container m-auto px-4"}"><section class="${"py-8 px-4 text-center"}"><div class="${"max-w-auto mx-auto"}"><div class="${"md:max-w-lg mx-auto text-9xl font-bold"}">${escape2(status)}</div>
				<h2 class="${"mt-8 uppercase text-xl lg:text-5xl font-black"}">We are sorry, Somthing went wrong!
				</h2>
				<p class="${"mt-6 uppercase text-sm lg:text-base text-gray-900"}">${escape2(error2.message)}</p>
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    file2 = "_app/immutable/pages/__error.svelte-4a712129.js";
    imports2 = ["_app/immutable/pages/__error.svelte-4a712129.js", "_app/immutable/chunks/index-1ad192d9.js"];
    stylesheets2 = [];
  }
});
...
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/index.svelte.js"() {
    ...
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `${$$result.title = `<title>Home Page Landing Page</title>`, ""}<meta name="${"robots"}" content="${"noindex nofollow"}" data-svelte="svelte-1d16i1c"><html lang="${"en"}" data-svelte="svelte-1d16i1c"></html>`, ""}

<div class="${"p-40 w-full mx-auto text-center"}"><h1 class="${"text-2xl dark:text-gray-100 text-gray-500 mb-8"}">Your Homepage Could Go Here</h1>
	<a href="${"/auth/login"}" class="${"rounded-md bg-gray-200 p-4 py-2 font-semibold"}">LOGIN</a>
	<a href="${"/app"}" class="${"rounded-md bg-gray-200 p-4 py-2 font-semibold"}">GO TO APP</a></div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/9.js"() {
    init_index_svelte();
    index3 = 9;
    file3 = "_app/immutable/pages/index.svelte-1f97d885.js";
    imports3 = ["_app/immutable/pages/index.svelte-1f97d885.js", "_app/immutable/chunks/index-1ad192d9.js"];
    stylesheets3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/__layout-app.svelte.js
var layout_app_svelte_exports = {};
__export(layout_app_svelte_exports, {
  default: () => _layout_app
});
...
var appInfo, layout, defaults, createToast, toast, css$3, ToastItem, css$2, SvelteToast, pages, NavItem, headerColors, Navbar, LogoutLink, NavItemSidebar, css$1, sideBarColors, sideBarIconColor, sideBarHover, Sidebar, css, _layout_app;
var init_layout_app_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout-app.svelte.js"() {
    init_index_30e4655b();
    init_DarkModeToggle_5c6d9d2a();
    init_userStore_f6242bd9();
    ...
    ToastItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${["_toastItem svelte-1cztund", item.pausable ? "pe" : ""].join(" ").trim()}"><div role="${"status"}" class="${["_toastMsg svelte-1cztund", item.component ? "pe" : ""].join(" ").trim()}">${item.component ? `${validate_component(item.component.src || missing_component, "svelte:component").$$render($$result, Object.assign(getProps()), {}, {})}` : `<!-- HTML_TAG_START -->${item.msg}<!-- HTML_TAG_END -->`}</div>
  ${item.dismissable ? `<div class="${"_toastBtn pe svelte-1cztund"}" role="${"button"}" tabindex="${"-1"}">\u2715</div>` : ``}
  <progress class="${"_toastBar svelte-1cztund"}"${add_attribute("value", $progress, 0)}></progress>
</div>`;
    });
    css$2 = {
    ...
    SvelteToast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<ul class="${"_toastContainer svelte-1u812xz"}">${each(items, (item) => {
        return `<li class="${escape2(null_to_empty(item.classes.join(" ")), true) + " svelte-1u812xz"}"${add_attribute("style", getCss(item.theme), 0)}>${validate_component(ToastItem, "ToastItem").$$render($$result, { item }, {}, {})}
    </li>`;
      })}
</ul>`;
    });
    ...
    NavItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.linkData === void 0 && $$bindings.linkData && linkData !== void 0)
        $$bindings.linkData(linkData);
      return `<li><a${add_attribute("href", link, 0)}><div class="${"nav-item"}"><i class="${"fas fa-" + escape2(icon, true)}"></i>
			<span class="${"label"}">${escape2(title)}</span></div></a></li>`;
    });
    headerColors = "bg-gray-200 dark:bg-gray-900 dark:text-gray-100 text-gray-600";
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_layout();
      $$unsubscribe_user();
      return `<nav class="${"flex items-center p-4 text-semibold px-2 mb-6 sm:px-4 py-2.5 " + escape2(headerColors, true)}"><div class="${"w-full flex flex-wrap " + escape2($layout.headerState.height, true) + " justify-between items-center"}"><div class="${"inline flex"}">${$layout.hasSidebar ? `<button class="${"mr-4"}"><i class="${"fa fa-bars"}"></i></button>` : ``}

			<a href="${"/app"}" class="${"inline flex items-center"}"><span class="${"text-xl font-bold whitespace-nowrap "}">${escape2(appInfo.name)}</span></a></div>

		<div id="${"navbar-default"}" class="${"w-full md:block md:w-auto"}"><ul class="${"flex flex-col rounded-lg border border-gray-100 md:flex-row md:space-x-12 md:mt-0 md:text-sm md:font-medium md:border-0"}">${$layout.headerState.showDarkMode ? `${validate_component(DarkModeToggle, "DarkModeToggle").$$render($$result, {}, {}, {})}` : ``}

				${pages && $layout.headerState.showMenuItems ? `${each(pages, (link) => {
        return `${$user && link.auth ? `${validate_component(NavItem, "NavItem").$$render($$result, { linkData: link }, {}, {})}` : `${!link.auth && !link.hideIfAuth ? `${validate_component(NavItem, "NavItem").$$render($$result, { linkData: link }, {}, {})}` : ``}`}`;
      })}` : ``}</ul></div></div></nav>`;
    });
    LogoutLink = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $layout, $$unsubscribe_layout;
      $$unsubscribe_layout = subscribe(layout, (value) => $layout = value);
      let { iconColor } = $$props;
      let { sidebarHover } = $$props;
      if ($$props.iconColor === void 0 && $$bindings.iconColor && iconColor !== void 0)
        $$bindings.iconColor(iconColor);
      if ($$props.sidebarHover === void 0 && $$bindings.sidebarHover && sidebarHover !== void 0)
        $$bindings.sidebarHover(sidebarHover);
      $$unsubscribe_layout();
      return `${$layout.sidebarState.collapsed ? `<button class="${"cursor-pointer flex items-center p-2 border-t pt-4 border-gray-400 text-base font-normal "}"><i class="${"fas fa-key text-2xl " + escape2(iconColor, true)}"></i></button>` : `<button class="${"cursor-pointer rounded-md flex items-center p-2 px-3 font-normal " + escape2(sidebarHover, true)}"><i class="${"fas fa-key mr-3 " + escape2(iconColor, true)}"></i> Logout</button>`}`;
    });
    NavItemSidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { linkData } = $$props;
      let { collapsed } = $$props;
      let { iconColor = "bg-gray-200" } = $$props;
      let { sidebarHover = "hover:bg-gray-100 dark:hover:bg-gray-700" } = $$props;
      const { icon, title, link, count } = linkData;
      if ($$props.linkData === void 0 && $$bindings.linkData && linkData !== void 0)
        $$bindings.linkData(linkData);
      ...
      if ($$props.sidebarHover === void 0 && $$bindings.sidebarHover && sidebarHover !== void 0)
        $$bindings.sidebarHover(sidebarHover);
      return `<li>${collapsed ? `<a${add_attribute("href", link, 0)} class="${"flex items-center p-3 border-t pt-4 border-gray-400 font-normal"}"><i class="${"fas text-2xl fa-" + escape2(icon, true) + " " + escape2(iconColor, true)}"></i></a>` : `<a${add_attribute("href", link, 0)} class="${"flex items-center p-2 px-3 rounded-md font-normal " + escape2(sidebarHover, true)}"><i class="${"fas fa-" + escape2(icon, true) + " " + escape2(iconColor, true)}"></i>
			<span class="${"flex-1 ml-3 whitespace-nowrap"}">${escape2(title)}</span>
			${count ? `<span class="${"inline-flex justify-center items-center p-3 px-4 ml-3 w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-200"}">${escape2(count)}</span>` : ``}</a>`}</li>`;
    });
    css$1 = {
      code: ".no-scrollbar.svelte-1jzdetb::-webkit-scrollbar{display:none}.no-scrollbar.svelte-1jzdetb{-ms-overflow-style:none;scrollbar-width:none}",
      map: null
    };
    sideBarColors = "shadow-lg text-gray-700 bg-gray-100 dark:text-gray-100 dark:bg-gray-900";
    sideBarIconColor = "dark:text-gray-500 text-gray-400 dark:hover:text-white";
    ...
    Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_layout();
      $$unsubscribe_user();
      return `<aside${add_attribute("class", $layout.sidebarState.collapsed ? "w-20" : "w-64", 0)} aria-label="${"Sidebar"}"><div class="${"overflow-y-auto no-scrollbar h-screen py-5 px-4 " + escape2(sideBarColors, true) + " svelte-1jzdetb"}"><a${add_attribute("href", appInfo.website, 0)} class="${"flex items-center pl-2.5 mb-6"}"><img${add_attribute("src", appInfo.logo, 0)} class="${"mr-3 h-6 sm:h-8"}" alt="${"App logo"}">
			${!$layout.sidebarState.collapsed ? `<span class="${"self-center text-xl font-semibold whitespace-nowrap dark:text-white text-black"}">${escape2(appInfo.brand)}</span>` : ``}</a>

		<ul class="${"space-y-4"}">${pages ? `${each(pages, (link) => {
        return `${$user && link.auth ? `${validate_component(NavItemSidebar, "NavItemSidebar").$$render(
          $$result,
          {
          ...
          {},
          {}
        )}` : `${!link.auth && !link.hideIfAuth ? `${validate_component(NavItemSidebar, "NavItemSidebar").$$render(
          $$result,
          {
            collapsed: $layout.sidebarState.collapsed,
            iconColor: sideBarIconColor,
          ...
          {}
			...
			${validate_component(LogoutLink, "LogoutLink").$$render(
        $$result,
        {
          iconColor: sideBarIconColor,
          sidebarHover: sideBarHover
		...
		${$layout.sidebarState.cta && !$layout.sidebarState.collapsed ? `<div id="${"dropdown-cta"}" class="${"p-4 mt-8 bg-blue-200 shadow-sm rounded-lg dark:bg-blue-900"}" role="${"alert"}"><div class="${"flex items-center mb-3"}"><span class="${"bg-orange-100 text-orange-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900"}">${escape2($layout.sidebarState.cta_data.label)}</span>
					<button type="${"button"}" class="${"ml-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-900 rounded-lg focus:ring-2 focus:ring-blue-400 p-1 hover:bg-blue-200 inline-flex h-6 w-6 dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800"}" data-collapse-toggle="${"dropdown-cta"}" aria-label="${"Close"}"><span class="${"sr-only"}">Close</span>
						<svg aria-hidden="${"true"}" class="${"w-4 h-4"}" fill="${"currentColor"}" viewBox="${"0 0 20 20"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill-rule="${"evenodd"}" d="${"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"}" clip-rule="${"evenodd"}"></path></svg></button></div>
				<p class="${"mb-3 text-sm text-blue-900 dark:text-blue-400"}">${escape2($layout.sidebarState.cta_data.body)}</p>
				<a class="${"text-sm text-blue-900 underline hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"}"${add_attribute("href", $layout.sidebarState.cta_data.link, 0)}>${escape2($layout.sidebarState.cta_data.linkText)}</a></div>` : ``}</div>
</aside>`;
    });
    css = {
      code: ":root{--toastContainerTop:auto;--toastContainerRight:4rem;--toastContainerBottom:4rem;--toastContainerLeft:calc(50vw - 8rem)}",
      map: null
    };
    _layout_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $layout, $$unsubscribe_layout;
      $$unsubscribe_layout = subscribe(layout, (value) => $layout = value);
      $$result.css.add(css);
      $$unsubscribe_layout();
      return `${$$result.head += `${$$result.title = `<title>${escape2(appInfo.name)}</title>`, ""}<meta name="${"robots"}" content="${"noindex nofollow"}" data-svelte="svelte-19fbm4"><html lang="${"en"}" data-svelte="svelte-19fbm4"></html>`, ""}

<main><div class="${"flex overflow-x-hidden h-screen"}">${$layout.hasSidebar ? `${$layout.sidebarState.shown ? `<div>${validate_component(Sidebar, "Sidebar").$$render($$result, {}, {}, {})}</div>` : ``}` : ``}

		<div class="${"flex-1"}">${$layout.hasHeader ? `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}` : ``}
			<main class="${"p-4"}">${slots.default ? slots.default({}) : ``}</main></div></div>

	${validate_component(SvelteToast, "SvelteToast").$$render(
        $$result,
        {
...
__export(__exports4, {
  ...
  imports: () => imports4,
  index: () => index4,
  module: () => layout_app_svelte_exports,
  stylesheets: () => stylesheets4
});
var index4, file4, imports4, stylesheets4;
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    init_layout_app_svelte();
    index4 = 2;
    file4 = "_app/immutable/pages/__layout-app.svelte-807d2b7e.js";
    imports4 = ["_app/immutable/pages/__layout-app.svelte-807d2b7e.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/DarkModeToggle-194779be.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/appLayout-7496642e.js"];
    stylesheets4 = ["_app/immutable/assets/__layout-app-7511d513.css", "_app/immutable/assets/DarkModeToggle-b0041227.css"];
  }
});

// .svelte-kit/output/server/entries/pages/app/index@app.svelte.js
var index_app_svelte_exports = {};
__export(index_app_svelte_exports, {
  default: () => Index_app,
  load: () => load3
});
async function load3({ session }) {
  if (!session.user || session.user == null) {
    return { status: 302, redirect: "/auth/login" };
  }
  return { props: { session } };
}
var DashboardPage, Index_app;
var init_index_app_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/app/index@app.svelte.js"() {
    init_index_30e4655b();
    init_js_cookie();
    init_userStore_f6242bd9();
    DashboardPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $user, $$unsubscribe_user;
      $$unsubscribe_user = subscribe(user, (value) => $user = value);
      $$unsubscribe_user();
      return `
...
<div class="${"w-full p-10"}"><h1 class="${"text-center text-4xl mt-20 mb-20 text-gray-400 dark:text-white"}">Dashboard Page Here
	</h1>

	<p>User Info :
		${escape2(JSON.stringify($user))}</p>

	<div class="${"w-full flex cols justify-between gap-4 mt-10"}"><div><button class="${"rounded-md mb-2 bg-gray-200 p-4 py-1 "}">Header Toggle
			</button> <br>
			<button class="${"rounded-md bg-gray-200 p-4 py-1 "}">Header Height</button></div>

		<div><button class="${"rounded-md bg-gray-200 mb-2 p-4 py-1 "}">Sidebar Toggle</button> <br>
			<button class="${"rounded-md bg-gray-200 p-4 py-1 "}">Sidebar Collapse</button></div>

		<div><button class="${"rounded-md bg-gray-200 mb-2 p-4 py-1 "}">Header Menu</button><br>
			<button class="${"rounded-md bg-gray-200 p-4 py-1 "}">Show Dark Mode Switch</button></div></div></div>`;
    });
    Index_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { session } = $$props;
...
${validate_component(DashboardPage, "DashboardPage").$$render($$result, {}, {}, {})}`;
    });
  }
});
...
__export(__exports5, {
  ...
  imports: () => imports5,
  index: () => index5,
  module: () => index_app_svelte_exports,
  stylesheets: () => stylesheets5
});
var index5, file5, imports5, stylesheets5;
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_index_app_svelte();
    index5 = 3;
    file5 = "_app/immutable/pages/app/index@app.svelte-0ab24fb7.js";
    imports5 = ["_app/immutable/pages/app/index@app.svelte-0ab24fb7.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/appLayout-7496642e.js"];
    stylesheets5 = [];
  }
});

// .svelte-kit/output/server/_app/immutable/chunks/DemoPage-280f3867.js
var DemoPage;
var init_DemoPage_280f3867 = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/DemoPage-280f3867.js"() {
    init_index_30e4655b();
    init_userStore_f6242bd9();
    DemoPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $user, $$unsubscribe_user;
      $$unsubscribe_user = subscribe(user, (value) => $user = value);
      let { number } = $$props;
...
<div class="${"p-20 text-gray-400 dark:text-white"}"><h1 class="${"text-center text-4xl "}">Page ${escape2(number)} here</h1>
	<p class="${"ml-20 mt-20"}">User Data : <br>
		${escape2(JSON.stringify($user))}</p></div>`;
    });
  }
});

// .svelte-kit/output/server/entries/pages/app/page1@app.svelte.js
var page1_app_svelte_exports = {};
__export(page1_app_svelte_exports, {
  default: () => Page1_app,
  load: () => load4
});
async function load4({ session }) {
  if (!session.user || session.user == null) {
    return { status: 302, redirect: "/auth/login" };
  }
  return { props: { session } };
...
var Page1_app;
var init_page1_app_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/app/page1@app.svelte.js"() {
    init_index_30e4655b();
    init_js_cookie();
    init_DemoPage_280f3867();
    init_userStore_f6242bd9();
    Page1_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { session } = $$props;
      if ($$props.session === void 0 && $$bindings.session && session !== void 0)
        $$bindings.session(session);
      return `
...
${validate_component(DemoPage, "DemoPage").$$render($$result, { number: 1 }, {}, {})}`;
    });
  }
});
...
__export(__exports6, {
  ...
  imports: () => imports6,
  index: () => index6,
  module: () => page1_app_svelte_exports,
  stylesheets: () => stylesheets6
});
var index6, file6, imports6, stylesheets6;
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    init_page1_app_svelte();
    index6 = 4;
    file6 = "_app/immutable/pages/app/page1@app.svelte-20e2aaff.js";
    imports6 = ["_app/immutable/pages/app/page1@app.svelte-20e2aaff.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/DemoPage-73edbb93.js"];
    stylesheets6 = [];
  }
});

// .svelte-kit/output/server/entries/pages/app/page2@app.svelte.js
var page2_app_svelte_exports = {};
__export(page2_app_svelte_exports, {
  default: () => Page2_app,
  load: () => load5
});
...
var Page2_app;
var init_page2_app_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/app/page2@app.svelte.js"() {
    init_index_30e4655b();
    init_js_cookie();
    init_DemoPage_280f3867();
    init_userStore_f6242bd9();
    Page2_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { session } = $$props;
      if ($$props.session === void 0 && $$bindings.session && session !== void 0)
        $$bindings.session(session);
      return `
...
${validate_component(DemoPage, "DemoPage").$$render($$result, { number: 2 }, {}, {})}`;
    });
  }
});
...
__export(__exports7, {
  ...
  imports: () => imports7,
  index: () => index7,
  module: () => page2_app_svelte_exports,
  stylesheets: () => stylesheets7
});
var index7, file7, imports7, stylesheets7;
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_page2_app_svelte();
    index7 = 5;
    file7 = "_app/immutable/pages/app/page2@app.svelte-2d84947b.js";
    imports7 = ["_app/immutable/pages/app/page2@app.svelte-2d84947b.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/DemoPage-73edbb93.js"];
    stylesheets7 = [];
  }
});

// .svelte-kit/output/server/entries/pages/app/page3@app.svelte.js
var page3_app_svelte_exports = {};
__export(page3_app_svelte_exports, {
  default: () => Page3_app,
  load: () => load6
});
async function load6({ session }) {
  if (!session.user || session.user == null) {
    return { status: 302, redirect: "/auth/login" };
  }
  return { props: { session } };
...
var Page3_app;
var init_page3_app_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/app/page3@app.svelte.js"() {
    init_index_30e4655b();
    init_js_cookie();
    init_DemoPage_280f3867();
    init_userStore_f6242bd9();
    Page3_app = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { session } = $$props;
      if ($$props.session === void 0 && $$bindings.session && session !== void 0)
        $$bindings.session(session);
      return `
...
${validate_component(DemoPage, "DemoPage").$$render($$result, { number: 3 }, {}, {})}`;
    });
  }
});
...
__export(__exports8, {
  ...
  imports: () => imports8,
  index: () => index8,
  module: () => page3_app_svelte_exports,
  stylesheets: () => stylesheets8
});
var index8, file8, imports8, stylesheets8;
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    init_page3_app_svelte();
    index8 = 6;
    file8 = "_app/immutable/pages/app/page3@app.svelte-97b89396.js";
    imports8 = ["_app/immutable/pages/app/page3@app.svelte-97b89396.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/DemoPage-73edbb93.js"];
    stylesheets8 = [];
  }
});

// .svelte-kit/output/server/_app/immutable/chunks/LoginForm-11387ffa.js
var boxColor, buttonColor, LoginForm;
var init_LoginForm_11387ffa = __esm({
  ".svelte-kit/output/server/_app/immutable/chunks/LoginForm-11387ffa.js"() {
    init_index_30e4655b();
    boxColor = "bg-gray-500 dark:bg-gray-900 text-white";
    buttonColor = "bg-yellow-600 text-white active:bg-gray-600 active:text-white dark:text-black";
    LoginForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { buttonText = "Sign In" } = $$props;
      let { formTitle = "Sign In" } = $$props;
      let { handleForm } = $$props;
      ...
      if ($$props.formTitle === void 0 && $$bindings.formTitle && formTitle !== void 0)
        $$bindings.formTitle(formTitle);
      if ($$props.handleForm === void 0 && $$bindings.handleForm && handleForm !== void 0)
        $$bindings.handleForm(handleForm);
      return `<div class="${"container pt-20 mx-auto h-full"}"><div class="${"flex content-center items-center justify-center h-full"}"><div class="${"w-full px-5"}"><div${add_attribute("class", "relative flex flex-col min-w-0 break-words w-full mb-3 shadow-lg rounded-lg border-0 " + boxColor, 0)}><div class="${"rounded-t px-4 py-6"}"><div class="${"text-center mb-3"}"><h6 class="${"text-gray-200 text-sm font-bold"}">${escape2(formTitle)}</h6></div>
					<hr class="${"mt-6 border-b-1 border-gray-300"}"></div>
				<div class="${"flex-auto px-10 lg:px-10 py-10"}"><form><div class="${"relative w-full mb-6"}"><label class="${"block uppercase text-gray-200 text-xs font-bold mb-2"}" for="${"grid-email"}">Email
							</label>
							<input id="${"grid-email"}" type="${"email"}" name="${"email"}" class="${"border-0 px-3 py-3 placeholder-gray-700 text-black bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"}" placeholder="${"Email"}"${add_attribute("value", email, 0)}></div>

						<div class="${"relative w-full mb-3"}"><label class="${"block uppercase text-gray-200 text-xs font-bold mb-2"}" for="${"grid-password"}">Password
							</label>
							<input id="${"grid-password"}" type="${"password"}" name="${"password"}" class="${"border-0 px-3 py-3 placeholder-gray-700 text-black bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"}" placeholder="${"Password"}"${add_attribute("value", password, 0)}></div>
						
						<div class="${"text-center mt-6"}"><button class="${"mt-4 " + escape2(buttonColor, true) + " text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"}" type="${"submit"}">${escape2(buttonText)}</button></div></form></div></div>
			<div class="${"flex flex-wrap"}"><div class="${"w-1/2"}"><a href="${"/auth/forgotpassword"}" class="${"text-gray-600 dark:text-gray-400"}"><small>Forgot password?</small></a></div>
...
// .svelte-kit/output/server/entries/pages/auth/login.svelte.js
var login_svelte_exports = {};
__export(login_svelte_exports, {
  default: () => Login,
  load: () => load7
});
async function load7({ session }) {
  if (session.user) {
    return { status: 302, redirect: "/app" };
  }
  return {};
...
var init_login_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/auth/login.svelte.js"() {
    ...
    init_userStore_f6242bd9();
    init_supabaseClient_e400011c();
    init_LoginForm_11387ffa();
    init_js_cookie();
    Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const login = async (email, password) => {
        const { user: user2, error: error2 } = await supabase.auth.signIn({ email, password });
        loginUser(user2);
        if (user2)
...
${validate_component(LoginForm, "LoginForm").$$render(
        $$result,
        {
        ...
        {},
        {
          default: () => {
            return `
	<a href="${"/auth/signup"}" class="${"text-gray-600 dark:text-gray-400"}"><small>Create new account</small></a>`;
          }
        }
      )}`;
    });
...
var init__9 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    init_login_svelte();
    index9 = 7;
    file9 = "_app/immutable/pages/auth/login.svelte-cbaa3135.js";
    imports9 = ["_app/immutable/pages/auth/login.svelte-cbaa3135.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/supabaseClient-62fcc2af.js", "_app/immutable/chunks/preload-helper-c28b9807.js", "_app/immutable/chunks/LoginForm-588bad00.js"];
    stylesheets9 = [];
  }
});
  ...
  ".svelte-kit/output/server/entries/pages/auth/signup.svelte.js"() {
    ...
    Signup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const signUp = async (email, password) => {
        const { user: user2, error: error2 } = await supabase.auth.signUp({ email, password });
        loginUser(user2);
        if (user2)
          window.location.replace("/app");
      };
...
${validate_component(LoginForm, "LoginForm").$$render(
        ...
        {},
        {
          default: () => {
            return `
	<a href="${"/auth/login"}" class="${"text-gray-600 dark:text-gray-400"}"><small>Already Have an Account? Login</small></a>`;
          }
        }
      )}`;
    });
...
var init__10 = __esm({
  ".svelte-kit/output/server/nodes/8.js"() {
    init_signup_svelte();
    index10 = 8;
    file10 = "_app/immutable/pages/auth/signup.svelte-ba932070.js";
    imports10 = ["_app/immutable/pages/auth/signup.svelte-ba932070.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/userStore-c8b7de9a.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/supabaseClient-62fcc2af.js", "_app/immutable/chunks/preload-helper-c28b9807.js", "_app/immutable/chunks/LoginForm-588bad00.js"];
    stylesheets10 = [];
  }
});
...
var Server = class {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module = await Promise.resolve().then(() => (init_hooks_65a46288(), hooks_65a46288_exports));
      this.options.hooks = {
...
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["favicon.ico", "robots.txt"]),
  mimeTypes: { ".ico": "image/vnd.microsoft.icon", ".txt": "text/plain" },
  _: {
    entry: { "file": "_app/immutable/start-77bf14c5.js", "imports": ["_app/immutable/start-77bf14c5.js", "_app/immutable/chunks/index-1ad192d9.js", "_app/immutable/chunks/index-f7e543ab.js", "_app/immutable/chunks/preload-helper-c28b9807.js"], "stylesheets": [] },
    nodes: [
